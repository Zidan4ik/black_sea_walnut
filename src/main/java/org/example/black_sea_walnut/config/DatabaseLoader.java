    ...
    public void run(String... args) throws Exception {
        if (newService.getAll().isEmpty()) {
            for (int i = 0; i < 3; i++) {
                ...
                new_.setPathToMedia("/uploads/default/image/default-image-nut.jpg");
        ...
        if (historyService.getAll().isEmpty()) {
            ...
            historyMain.setBanner(new Banner(null, "/uploads/default/image/default-image-nut.jpg", MediaType.image, historyMain));
            ...
            historyMain.getHistoryMedia().add(new HistoryMedia(null, MediaType.image, "/uploads/default/image/default-image-nut.jpg", historyMain));
            historyMain.getHistoryMedia().add(new HistoryMedia(null, MediaType.image, "/uploads/default/image/default-image-nut.jpg", historyMain));
            ...
            historyFactory.getHistoryMedia().add(new HistoryMedia(null, MediaType.image, "/uploads/default/image/default-image-nut.jpg", historyFactory));
            historyFactory.getHistoryMedia().add(new HistoryMedia(null, MediaType.image, "/uploads/default/image/default-image-nut.jpg", historyFactory));
            ...
            historyAim.setBanner(new Banner(null, "/uploads/default/image/default-image-nut.jpg", MediaType.image, historyAim));
            ...
            historyEcoProduction.setBanner(new Banner(null, "/uploads/default/image/default-image-nut.jpg", MediaType.image, historyEcoProduction));
            ...
            catalogBanner.setBanner(new Banner(null, "/uploads/default/image/default-image-nut.jpg", MediaType.image, catalogBanner));
            ...
            catalogBanner.getHistoryMedia().add(new HistoryMedia(null, MediaType.image, "/uploads/default/image/default-image-nut.jpg", historyFactory));
            catalogBanner.getHistoryMedia().add(new HistoryMedia(null, MediaType.image, "/uploads/default/image/default-image-nut.jpg", historyFactory));
            ...
            factoryBanner.setBanner(new Banner(null, "/uploads/default/image/default-image-nut.jpg", MediaType.image, factoryBanner));
            ...
            clientBanner.setBanner(new Banner(null, "/uploads/default/image/default-image-nut.jpg", MediaType.image, clientBanner));
            ...
            clientEcoProduction.setBanner(new Banner(null, "/uploads/default/image/default-image-nut.jpg", MediaType.image, clientEcoProduction));
        ...
        if (clientCategoryService.getAll().isEmpty()) {
            ...
            clientCategory1.setPathToImage("/uploads/default/image/default-image-nut.jpg");
            clientCategory1.setPathToSvg("/uploads/default/image/default-image-nut.jpg");
            ...
            clientCategory2.setPathToImage("/uploads/default/image/default-image-nut.jpg");
            clientCategory2.setPathToSvg("/uploads/default/image/default-image-nut.jpg");
        ...
        if (productService.getAll().isEmpty()) {
            for (int i = 1; i <= 10; i++) {
                ...
                product.setPathToImage1("/uploads/default/image/default-image-nut.jpg");
                product.setPathToImage2("/uploads/default/image/default-image-nut.jpg");
                product.setPathToImage3("/uploads/default/image/default-image-nut.jpg");
...
//                product.setPriceByUnit(String.valueOf((int) Double.parseDouble(faker.number().numberBetween(1, 50))));
        ...
        if (galleryRepository.findAll().isEmpty()) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                gallery.setPathToMedia("/uploads/default/image/default-image-nut.jpg");
        ...
        if (nutRepository.findAll().isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                nut.setPathToImage("/uploads/default/image/default-image-nut.jpg");
                nut.setPathToSvg("/uploads/default/image/default-image-nut.jpg");
